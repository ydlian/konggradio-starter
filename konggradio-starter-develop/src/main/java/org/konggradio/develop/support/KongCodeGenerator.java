 ...
 *
 */
package org.konggradio.develop.support;
...
import org.konggradio.develop.constant.DevelopConstant;
...
@Data
@Slf4j
public class KongCodeGenerator {
	/**
	 * 代码所在系统
	 */
	 ...
	 * 代码所在服务名
	 */
	private String serviceName = "kongGradio-service";
	/**
	 * 代码生成的包名
	 */
	private String packageName = "org.konggradio.test";
	/**
	 * 代码后端生成的地址
	 */
	 ...
	 * 需要去掉的表前缀
	 */
	private String[] tablePrefix = {"konggradio_"};
	/**
	 * 需要生成的表名(两者只能取其一)
	 */
	private String[] includeTables = {"konggradio_test"};
	/**
	 * 需要排除的表名(两者只能取其一)
	 */
	...
	public void run() {
		...
		if (hasSuperEntity) {
			strategy.setSuperEntityClass("org.konggradio.core.mp.base.BaseEntity");
			strategy.setSuperEntityColumns(superEntityColumns);
			strategy.setSuperServiceClass("org.konggradio.core.mp.base.BaseService");
			strategy.setSuperServiceImplClass("org.konggradio.core.mp.base.BaseServiceImpl");
		} else {
			strategy.setSuperServiceClass("com.baomidou.mybatisplus.extension.service.IService");
			strategy.setSuperServiceImplClass("com.baomidou.mybatisplus.extension.service.impl.ServiceImpl");
		}
		// 自定义 controller 父类
		strategy.setSuperControllerClass("org.konggradio.core.boot.ctrl.KongCloudController");
	...
	private InjectionConfig getInjectionConfig() {
		...
		if (Func.isNotBlank(packageWebDir)) {
			if (Func.equals(systemName, DevelopConstant.SWORD_NAME)) {
				...
				focList.add(new FileOutConfig("/templates/front/view.js.vm") {
					@Override
					public String outputFile(TableInfo tableInfo) {
				...
				focList.add(new FileOutConfig("/templates/acp/api.js.vm") {
					@Override
					public String outputFile(TableInfo tableInfo) {
						return getOutputWebDir() + "/api" + "/" + servicePackage.toLowerCase() + "/" + tableInfo.getEntityName().toLowerCase() + ".js";
					}
				});
				focList.add(new FileOutConfig("/templates/acp/crud.vue.vm") {
					@Override
					public String outputFile(TableInfo tableInfo) {
	...
	public String getOutputDir() {
		return (Func.isBlank(packageDir) ? System.getProperty("user.dir") + "/kongGradio-ops/kongGradio-develop" : packageDir) + "/src/main/java";
	}
