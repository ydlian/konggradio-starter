...
public interface PluginConstants {
     ...
     */
    String META_PATH = "/kongGradio-client/register-metadata";
     ...
     */
    String URI_PATH = "/kongGradio-client/register-uri";
    ...
    String KONGGRADIO_ADMIN_PATH_CONFIGS_FETCH = "/configs/fetch";

    String KONGGRADIO_ADMIN_PATH_CONFIGS_LISTENER = "/configs/listener";
