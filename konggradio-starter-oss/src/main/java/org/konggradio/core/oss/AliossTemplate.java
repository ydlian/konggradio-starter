...
import org.konggradio.core.oss.model.KongGradioFile;
import org.konggradio.core.oss.model.OssFile;
...
public class AliossTemplate {
	...
	@SneakyThrows
	public KongGradioFile putFile(MultipartFile file) {
		return putFile(ossProperties.getBucketName(), file.getOriginalFilename(), file);
	}

	@SneakyThrows
	public KongGradioFile putFile(String fileName, MultipartFile file) {
		return putFile(ossProperties.getBucketName(), fileName, file);
	}

	@SneakyThrows
	public KongGradioFile putFile(String bucketName, String fileName, MultipartFile file) {
		return putFile(bucketName, fileName, file.getInputStream());
	}

	@SneakyThrows
	public KongGradioFile putFile(String fileName, InputStream stream) {
		return putFile(ossProperties.getBucketName(), fileName, stream);
	}

	@SneakyThrows
	public KongGradioFile putFile(String bucketName, String fileName, InputStream stream) {
		return put(bucketName, stream, fileName, false);
	}

	@SneakyThrows
	public KongGradioFile put(String bucketName, InputStream stream, String key, boolean cover) {
		...
		KongGradioFile file = new KongGradioFile();
