...
public class INetUtil {
	...
	public static String findFirstNonLoopbackAddress() {
		String ip = new InetUtils(new InetUtilsProperties()).findFirstNonLoopbackAddress().getHostAddress();
		return ip;
	}
	/**
	 * 获取 服务器 hostname
	...
	public static String getIpAddressFromHttpHeaders(HttpHeaders httpHeaders){
		...
		return "0:0:0:0:0:0:0:1".equals(ip) ? "127.0.0.1" : NetUtil.getMultistageReverseProxyIp(ip);
	}
}
