 ...
 *  @since 2024-9-25
 *  @file: ExponentiallyDecayingReservoir.java
 *  <p>
...
import org.konggradio.mertrics.WeightedSnapshot.WeightedSample;
            ...
            if (lastScaleTick.compareAndSet(lastTick, now)) {
                ...
                if (Double.compare(scalingFactor, 0) == 0) {
                    ...
                    for (Double key : keys) {
                        ...
                        final WeightedSnapshot.WeightedSample newSample = new WeightedSample(sample.value, sample.weight * scalingFactor);
