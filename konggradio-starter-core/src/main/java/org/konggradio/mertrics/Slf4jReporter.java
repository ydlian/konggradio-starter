...
public class Slf4jReporter extends ScheduledReporter {
    ...
    private void logTimer(StringBuilder b, String name, Timer timer) {
        ...
        appendDoubleDurationIfEnabled(b, MetricAttribute.MEAN, snapshot::getMean);
        appendDoubleDurationIfEnabled(b, MetricAttribute.STDDEV, snapshot::getStdDev);
        appendDoubleDurationIfEnabled(b, MetricAttribute.P50, snapshot::getMedian);
        appendDoubleDurationIfEnabled(b, MetricAttribute.P75, snapshot::get75thPercentile);
        appendDoubleDurationIfEnabled(b, MetricAttribute.P95, snapshot::get95thPercentile);
        appendDoubleDurationIfEnabled(b, MetricAttribute.P98, snapshot::get98thPercentile);
        appendDoubleDurationIfEnabled(b, MetricAttribute.P99, snapshot::get99thPercentile);
        appendDoubleDurationIfEnabled(b, MetricAttribute.P999, snapshot::get999thPercentile);
    ...
    private void logHistogram(StringBuilder b, String name, Histogram histogram) {
        ...
        appendDoubleIfEnabled(b, MetricAttribute.MEAN, snapshot::getMean);
        appendDoubleIfEnabled(b, MetricAttribute.STDDEV, snapshot::getStdDev);
        appendDoubleIfEnabled(b, MetricAttribute.P50, snapshot::getMedian);
        appendDoubleIfEnabled(b, MetricAttribute.P75, snapshot::get75thPercentile);
        appendDoubleIfEnabled(b, MetricAttribute.P95, snapshot::get95thPercentile);
        appendDoubleIfEnabled(b, MetricAttribute.P98, snapshot::get98thPercentile);
        appendDoubleIfEnabled(b, MetricAttribute.P99, snapshot::get99thPercentile);
        appendDoubleIfEnabled(b, MetricAttribute.P999, snapshot::get999thPercentile);
        loggerProxy.log(marker, b.toString());
    }
    ...
    private void logCounter(StringBuilder b, String name, Counter counter) {
        ...
        append(b, "name", prefix(name));
        append(b, MetricAttribute.COUNT.getCode(), counter.getCount());
        loggerProxy.log(marker, b.toString());
    }
    ...
    private void appendCountIfEnabled(StringBuilder b, Counting counting) {
        if (!getDisabledMetricAttributes().contains(MetricAttribute.COUNT)) {
            append(b, MetricAttribute.COUNT.getCode(), counting.getCount());
        }
    }

    private void appendMetered(StringBuilder b, Metered meter) {
        appendRateIfEnabled(b, MetricAttribute.M1_RATE, meter::getOneMinuteRate);
        appendRateIfEnabled(b, MetricAttribute.M5_RATE, meter::getFiveMinuteRate);
        appendRateIfEnabled(b, MetricAttribute.M15_RATE,  meter::getFifteenMinuteRate);
        appendRateIfEnabled(b, MetricAttribute.MEAN_RATE,  meter::getMeanRate);
    }
