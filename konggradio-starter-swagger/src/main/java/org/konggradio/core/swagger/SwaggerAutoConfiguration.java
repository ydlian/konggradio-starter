 ...
 *  @since 2024-9-25
 *  @file: SwaggerAutoConfiguration.java
 *  <p>
...
public class SwaggerAutoConfiguration {
	...
	public Docket api(SwaggerProperties swaggerProperties) {
		Class<SwaggerLauncherServiceImpl> swaggerLauncherServiceImplClass = SwaggerLauncherServiceImpl.class;
		EnableSwagger an = swaggerLauncherServiceImplClass.getAnnotation(EnableSwagger.class);
		if (an != null) {
			boolean flag = an.isEnable();
			System.out.println("SwaggerAutoConfiguration:" + flag);
		}
		// base-path处理
		...
		return apis.build()
			...
			.securitySchemes(Collections.singletonList(securitySchema(swaggerProperties)))
			.extensions(openApiExtensionResolver.buildExtensions(kongProperties.getName()));
	}
